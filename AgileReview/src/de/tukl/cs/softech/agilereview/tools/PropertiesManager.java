...
/**
 * The PropertiesManager manages the internal configurations (in file: "OSGI-INF/l10n/bundle.properties") as well as the external (workspace-specific)
 * configurations (called preferences)
 */
public class PropertiesManager implements IInputValidator {
    
    /**
     * Static class for accessing keys of the internal properties Private keys should not be accessed directly but via methods specified in
    ...
    public static class INTERNAL_KEYS {
        ...
        public static String[] DEFAULT_ANNOTATION_COLORS_AUTHOR = new String[] { "annotations.default.color.author0",
                "annotations.default.color.author1", "annotations.default.color.author2", "annotations.default.color.author3",
                "annotations.default.color.author4", "annotations.default.color.author5", "annotations.default.color.author6",
                "annotations.default.color.author7", "annotations.default.color.author8", "annotations.default.color.author9" };
        /**
    ...
    /**
     * Static class for accessing keys of the external properties (=preferences). These preferences are stored in the users workspace and are
     * therefore workspace-specific. Private keys should not be accessed directly but via methods specified in {@link PropertiesManager}
     */
    public static class EXTERNAL_KEYS {
         ...
         * Default color of AgileReview annotations for author 1
         */
        public static String[] ANNOTATION_COLORS_AUTHOR = new String[] { "annotationColorAuthor0", "annotationColorAuthor1",
                "annotationColorAuthor2", "annotationColorAuthor3", "annotationColorAuthor4", "annotationColorAuthor5", "annotationColorAuthor6",
                "annotationColorAuthor7", "annotationColorAuthor8", "annotationColorAuthor9" };
        /**
    ...
    /**
     * Saves the new configuration for supported languages in the preferences. Beforehand all double entities will be removed.
     * @param newConfig
     */
