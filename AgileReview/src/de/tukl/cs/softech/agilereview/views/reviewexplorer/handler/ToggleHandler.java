 ...
 * 
 * <pre> &lt;command id=&quot;somecommand&quot; name=&quot;SomeCommand&quot;&gt; &lt;state class=&quot;org.eclipse.jface.commands.ToggleState&quot;
 * id=&quot;STYLE&quot;/&gt; &lt;/command&gt; </pre>
 * 
 ...
 * 
 * See http://www.ralfebert.de/blog/eclipsercp/togglehandler/ http://eclipsesource.com/blogs/2009/01/15/toggling-a-command-contribution/
 * 
 * @author Ralf Ebert
 */
public abstract class ToggleHandler extends AbstractHandler implements IElementUpdater {
    ...
    public final Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (state == null) throw new ExecutionException("You need to declare a ToggleState with id=STYLE for your command to use ToggleHandler!");
    ...
    public void updateElement(UIElement element, Map parameters) {
        if (this.commandId != null) {
            ...
            if (state != null) element.setChecked((Boolean) state.getValue());
        }
    }
