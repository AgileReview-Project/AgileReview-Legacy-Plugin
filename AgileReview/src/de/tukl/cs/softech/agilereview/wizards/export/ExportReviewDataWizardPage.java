...
public class ExportReviewDataWizardPage extends WizardPage implements SelectionListener, ModifyListener, Listener {
     ...
     */
    private final HashMap<String, Review> reviews = new HashMap<String, Review>();
    /**
     * all reviews that are selected in the wizard
     */
    private final HashSet<String> selectedReviewIDs = new HashSet<String>();
     ...
     * @return true, if all paths are valid<br> false, otherwise
     */
