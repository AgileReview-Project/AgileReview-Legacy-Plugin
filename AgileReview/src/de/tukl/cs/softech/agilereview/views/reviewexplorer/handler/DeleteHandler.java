...
/**
 * Handler for deleting comments based on the selection in the ReviewExplorer Active when: ReviewExplorer is activePart Enabled when: Arbitrary number
 * of AbstractMulipleWrappers are selected
 */
public class DeleteHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (sel1 != null) {
            ...
            if (!sel1.isEmpty()
                    && !MessageDialog.openConfirm(HandlerUtil.getActiveShell(event), "Review Explorer - Delete",
                            "Are you sure you want to delete all comments of this selection?")) { return null; }
