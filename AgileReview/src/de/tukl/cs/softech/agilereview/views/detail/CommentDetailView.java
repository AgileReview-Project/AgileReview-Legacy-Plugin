 ...
 */
public class CommentDetailView extends ViewPart {
    
    /** View ID */
    public static final String VIEW_ID = "de.tukl.cs.softech.agilereview.view.commentdetailview.view";
    ...
    private void changeParent(int type) {
        ...
        SourceProvider sp2 = (SourceProvider) isps.getSourceProvider(SourceProvider.COMMENT_CONTENT_AVAILABLE);
        ...
        case EMPTY:
            ...
            sp2.setVariable(SourceProvider.COMMENT_CONTENT_AVAILABLE, false);
        ...
        case COMMENT_DETAIL:
            ...
            sp2.setVariable(SourceProvider.COMMENT_CONTENT_AVAILABLE, true);
        ...
        case RELOCATE_DIALOG:
            ...
            this.setPartName("Comment Details - Relocate...");
    ...
    public void createPartControl(Composite parent) {
        PluginLogger.log(this.getClass().toString(), "createPartControl", "CommentDetailView will be created");
        instance = this;
    ...
    public void selectionChanged(SelectionChangedEvent event) {
        if (!event.getSelection().isEmpty() && event.getSelection() instanceof IStructuredSelection) {
            ...
            if (e instanceof Comment) {
                if (!(this.currentParent instanceof CommentDetail)) {
                    this.changeParent(CommentDetailView.COMMENT_DETAIL);
                }
