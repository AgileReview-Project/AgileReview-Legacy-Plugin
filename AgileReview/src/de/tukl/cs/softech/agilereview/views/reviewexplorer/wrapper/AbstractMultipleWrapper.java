...
/**
 * Abstract implementation of a Wrapper which can wrap multiple xml-nodes which represent the same file path.
 */
public abstract class AbstractMultipleWrapper implements Comparable<AbstractMultipleWrapper> {
    ...
    /**
     * Abstract method returning the children of this wrapper. Each subclass of this abstract class has to implement this routine itself.
     * @return array of all children of this wrapper
     */
    public abstract Object[] getChildren();
    
    /**
     * Abstract method for creating the path representing this wrapper. Each subclass of this abstract class has to implement this routine itself
