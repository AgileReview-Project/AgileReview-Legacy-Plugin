...
/**
 * This handler takes care of the command for selective collapse of all sub nodes of a given node in the ReviewExplorer
 */
                ...
                for (Object o : ((IStructuredSelection) selection).toArray()) {
                    if (o instanceof AbstractMultipleWrapper) {
                        if (ViewControl.isOpen(ReviewExplorer.class)) {
                            ReviewExplorer.getInstance().collapseAllSubNodes((AbstractMultipleWrapper) o);
                        }
                    }
                }
            }
