...
public class RefactoringKit {
	 ...
	 * and no new condition checker will be added to this file.
	 ...
	 * @param participant the reference of the refactoring participant which calls this function in order to get
	 * possible changes for each file which could be done by other participants beforehand
	 * @return a {@link CompositeChange} which comprises all changes
	 */
	static Change createChange(Collection<IFile> affectedFiles, Map<IFile, String> prevDocs, Map<IFile, String> postDocs, RefactoringParticipant participant) {
